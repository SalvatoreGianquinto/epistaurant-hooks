...
const Home = function () {
  ...
  //state = {
  // questo è l'oggetto di stato di questo componente
  // può contenere TUTTE le proprietà che volete
  // deve chiamarsi obbligatoriamente "state"
  //activePasta: pastasciutte[0], // carbonara
  // ogni proprietà dell'oggetto state identifica lo stato INIZIALE del componente
  // activePasta sarà SEMPRE un oggetto "pastasciutta" }
